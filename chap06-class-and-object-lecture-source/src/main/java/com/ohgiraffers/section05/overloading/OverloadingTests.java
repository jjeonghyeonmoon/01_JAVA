...
public class OverloadingTests {
    ...
    /* comment.
    *   오버로딩 사용 이유
    *   매개변수 종류별로 메소드 내용을 다르게 작성해야 하는 경우가 종종 있다.
    *   이 떄, 동일한 기능의 메소드를 매개변수에 따라 다르게 이름을 붙이게 되면,
    *   메소드의 이름을 다 외우고 관리하기 힘들것이다.
  ...
  //  public void test(){}
    ...
    // 접근제한자를 바꾸어도 메소드 시그니처 같기 떄문에 오류 발생
  //  private void test(){}
  ...
  //  public int test(){return 0;}
    ...
    // 변수명은 매개변수의 이름은 메소드 시그니처에 영향을 주지 않는다!!!
  //  public void test(int num1){}

    //매개변수 갯수에 다라서 오버로딩 성립 확인
    public void test(int num,int num1){}

    //매개 변수 타입 변화에 따른 오버로딩 성립 확인
