...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   우리는 너무많은 정보를 가지고 있다. ex) 키, 몸무게, 주소 등등등등등
        ...
        *    2. 자돌차는 시동걸기, 앞으로 가기, 멈추기, 시동끄기를 할 수 있다.
        ...
        *    8.카레이서가 시동을 끄면 더 이상 자동차는 움직이지 않는단.
        ...
        *   2.CarRacer
        *   -속성 : 자동차
        *   -행위 : 시동을 걸어라, 엑셀을 밟아라, 브레이크밟아라, 시동을 꺼라
        *   3.Car 클래스
        *   -속성 : 시동상태, 현재시속
        *   -행위 : 시동을 걸어라, 앞으로가라, 시동을 꺼라
        * */
        ...
        while (true) {
            ...
            switch (no) {
                ...
                case 3: racer.stepBreak();
                    break;
                case 4:racer.turn0ff();
                    break;
                case 9:racer.car.stop();
