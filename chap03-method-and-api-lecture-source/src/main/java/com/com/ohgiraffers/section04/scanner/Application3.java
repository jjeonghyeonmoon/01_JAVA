package com.com.ohgiraffers.section04.scanner;
...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        /* title. Scanner 사용 시 주의 사항에 대해 이해할 수 있다. */

        /*comment.
        *   스캐너의 next메소드들은 입력한 내용을 버퍼로부터 토큰 단위로 분리해서
        *   읽어오게 된다.
        *   그래서 크게 2가지 사항을 주의해야 한다.
        *   1. next() 로 문자열을 입력 받은 후 점수, 실수, 논리값 입력 받을 떄
        *   2. 정수, 실수, 논리값 입력 후 next() 로 문자열 입력 받을 떄
        * */
        ...
        *  hi 만 입력을 하고 정수를 입력 하면 정삭적으로 동작을 한다.
        *  하지만, hi world 를 입력하게 되면 숫자를 입력하지 않았음에도
        *  inputMisMatch 오류가 발생하게 된다.
        *  -> 공백이 있는 문자열을 입력해야 된다. = nextLine() 를 쓰면 된다.
        *  -> sc.nextLine(); 을 호출 중간에 넣어만 줘도 해결이 된다.*/
        ...
        /* index. 2. 정수, 실수, 논리값 입력 후 nextLine() 로 문자열을 입력 받을 떄*/
