...
public class A_for {
    ...
    public void testSimpleForStatement() {
        ...
        // index. 문제 1부터 10까지 1 씩 증가시키면서 i 값을 출력하는 반복문
        // 초기식 : int i = 1;
        // 조건식 : i <= 10;
        // 증감식 : i++
...
//        System.out.println("10 번쨰 학생의 이름은 " + student10 + " 입니다.");
        ...
        *   - 3. 저장 된 이름을 출력 */
        ...
        /* comment.
        *   둘 중 어떤 코드가 좋은 코드일까??
        *   둘 다 좋은 코드다 why? -> 요구사항 만족했기 떄문에 좋은 코드다.
        *   하지만, 반복문을 사용하는 것이 더좋은 코드다.
        *   1. 보다 간결하게 작성이 되었다.(가독성 상승)
        *   2. 학생의 이름 뿐 아니라, 성적이나 이름을 입력하는 기능도 추가를 해야 한다면? (유지보수성 상승) */
