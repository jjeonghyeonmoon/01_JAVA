...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* comment.
        *   java 에서 컬렉션 프레임워크 여러 개의 다양한 데이터들을
        ...
        *   -key 는 중복이 될 수 없지만, key 값이 다르다면 value이 중복이
        *   -가능하다.
        ...
        * */
        ...
        /* comment.
        *   ArrayList 는 배열의 단점을 보완하기 위해 만들어졋다.
...
//        List list = new List();
        ...
        System.out.println("alist의 크기 = " + alist.size());
        ...
        // 지정된 위치에 값을 수정
        alist.set(1, Boolean.valueOf(true)); //Wrapper 클래스로 boolean 값 Boolean 타입으로 바꾸기
        System.out.println("alist = " + alist);

        /* comment. 모든 컬렉션 프레임워크 클래스는 제네릭 클래스로 지정되어 있다.
        *   따라서 우리가 <> 내부에 타입을 지정하면 해당하는 공간은 지정한 타입 외에는 사용할 수 없게 된다.*/
        ...
        /* comment.
        *   정렬 기능도 사용할 수 있다.
        *   저장 순서를 유지하고 stringList 를 오름차순 정렬
        *   */

        Collections.sort(stringList);
        System.out.println("stringList = " + stringList);

        /* comment. 조금 복잡하지만, 내림차순 정렬도 가능하다.
        ...
        *   인덱스로 관리되는 컬렉션이 아닌 경우는 반복문을 사용해서 요소에 접근 할 수
