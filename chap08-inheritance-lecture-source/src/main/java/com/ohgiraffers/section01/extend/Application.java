...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   부모가 가지고 있는 멤버(필드,메소드)를 자식이 물려받는
        ...
        *   물려받은 멤버를 확장 하거나, 추가적인 멤버를 작성하는 것도 가능하다.
        *   특히 메소드 재정의(overriding) 라는 기술을 통해 부모가 가진 메소드를
        *   자식이 다시 정의하는 것이 가능하다.
        * */
        ...
        *       1-1. 재사용 시 생산성을 크게 항상 시킬 수 있다.(새롭게 작성 안 해도 됨)
        ...
        *       상속 구조가 복잡해 질 수록 그 영향에 대한 에측이 힘들어지며
        *       이러한 복잡한 구조는 오히려 유지보수성을 약화 시킬 수 있다.
...
//        fireCar.isRunning();
        ...
        /* index. 3. 소방차 너무 재미없게 경적을 울린다..그리고 소방차는 물을 뿌리는 기능도 있으면 좋지 않을까? */
