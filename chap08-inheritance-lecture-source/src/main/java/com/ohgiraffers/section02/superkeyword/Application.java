...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        Product product2 = new Product("S-01234", "상송", "갤럭시폴드6",2220000, LocalDateTime.now());
        ...
        Computer computer3 = new Computer("S-01234", "상송", "갤럭시폴드6",2220000, LocalDateTime.now(),"인텔",512,16,"윈도우");
