...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        *   그래서 만약에 ++num1 동작을 했다면, result 출력 했을 때 11이 나와야 하지만,
        *   결과가 10이 나온 것을 보아하니 뒤 코드가 동작하지 않은 것을 출력을 통해 확인을 해보았다.
        * */
        int num1 = 10;
        ...
        *   첫 번째 조건식에서 false 가 나오게 되면 뒤에 조건은 확인하지 않는다.
        ...
        * */
        ...
        System.out.println("|| 연산 실행 확인해보기 : " + result2);
