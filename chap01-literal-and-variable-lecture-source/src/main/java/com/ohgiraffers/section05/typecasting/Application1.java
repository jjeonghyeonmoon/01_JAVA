...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* index. 1-1. 작은 자료형에서 큰자료형으로는 자동형변환 된다.*/
        /* comment. 작은 자료형에서 큰 자료형으로 공간만 옮기는 경우
        *   데이터의 유실은 발생하지 않기 떄문에 컴파일러가 자동으로 해준다.*/
...
//        float result2 = fnum + dnum; 마찬가지다.
        ...
        *   why? 그냥 소수점만 추가되는 것이기 때문에. ex) 30 => 30.0 으로 바뀔뿐 달라지는건 없기 떄문이다.*/
        ...
        /* comment. 어떠한 자료형이던 boolean 은 형변환 해서 담을 수 없다.*/
