...
public class Application2 {
    public static void main(String[] args) {
        ...
        * 2. 변수에 값을 대입한다.(값 대입 및 초기화) / 초기화 = 코딩에서 초기화는 초기에 값을 설정한다. 삭제x
        * 3. 변수를 사용한다.
        *
        * */
...
//        double dnum; = //8byte
        ...
        snum = 2;
        inum = 4;
        lnum = 8L; // 소문자 l 을 써도 되지만, 숫자1과 혼선 여부가 있어 대문자를 주로사용한다.

        /* 목차. 2-2 실수를 취급하는 자료형에 값 대입해보기 */
//        fnum = 3.14f; // 대문자 F를 써도 되지만, 소문자를 쓰는 것이 일반적이다.
//        dnum = 8.0;
