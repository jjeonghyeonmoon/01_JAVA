...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 목차. 1-1. 동일한 범위 내에서 동일한 변수명은 가질 수 없다. 중요*/
        int age = 20;
...
//            int kfowafkaqweqweqweqweqeqweqeq


        /* 목차. 2-2. 변수명이 합성어(2개 단어 합쳐진) 경우 첫 단어는 소문자,
        *             두 번쨰 시작 단어는 대문자로 시작한다.
        * */
    ...
    boolean isDead = false; // 이런식으로 X
    boolean isAlive = true; // GOOD
