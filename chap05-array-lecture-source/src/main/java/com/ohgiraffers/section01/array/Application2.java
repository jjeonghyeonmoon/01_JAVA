...
public class Application2 {
    ...
    /* title. 배열의 사용 방법을 익혀 배열을 사용할 수 있다.*/
        ...
        *   */
        ...
        /* index. 2. 할당*/
        /* comment.
        *   우리가 위에서 선언한 래퍼런스변수ㅔ 배열을 할당하여 대입할 수 있다.
        *   new 할당 연산자는 heap 영역에 공간을 할당하고, 발생한 주소값을
        *   반환해주는 연산자 이다.
        *   발생한 주소를 레퍼런스 변수(참)에 저장하고 이것을 참조하여
...
//        iarr = new int[]; 공간을 지정하지 않으면 에러 발생
        ...
        /*comment.
        *  heap 메모리는 이름으로 접근 하는 것이 아닌 주소로 접근을 하는 것이다.
        *  stack 에 저장된 주소로 heap 에 할당이 된 배열을 찾아갈 수 있다.*/
        System.out.println("iarr2 = " + iarr2);
        System.out.println("carr2 = " + carr2);

        /* comment.
        *   hashcode() : 일반적으로 객체의 주소값을 10진수 = > 우리가 알 수 있는 정수로
        *   바꾸어주는 메소드 동일객체인 지 비교할 때 주로 쓰인다.*/

        System.out.println("iaar2 의 hashcode : " + iarr2.hashCode());
        System.out.println("caar2 의 hashcode : " + carr2.hashCode());
        ...
        *   heap 의 old 영역으로 이동하여 GC(가비지 컬렉터)가 삭제를 해준다.*/
