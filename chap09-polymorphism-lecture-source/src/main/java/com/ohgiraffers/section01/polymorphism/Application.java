...
//        개구리 f1 = new 동물();
        ...
        *   런타임 시 실제 객체를가진 오버라이딩 된 메소드(개구리,너구리)로 바인딩이 바뀌어
        *   동작하는 것을 의미한다.
        * */
        /* index. 2. 동적 바인딩 확인 */
...
//        a1.낼름공격();
        ...
        // 컴파일 시에는 문제 없지만, 런타임 시 ClassCast 오류발생
//        ((너구리)a1).깨물기();
        ...
        System.out.println("a1 이 object 타입인 지 확인 : " + (a1 instanceof 너구리 ));
