...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *   기본(원신)타입을 래퍼클래스로 인스턴스화 하는 것을 Boxing 이라고 하며,
